#!/usr/bin/env bash
# nightly-deps-agent.sh - nightly runner for the compass Android project.
#
...
REPO="${NIGHTLY_DEPS_REPO:-/home/user/compass}"
BRANCH="${NIGHTLY_DEPS_BRANCH:-master}"      # compass default branch is master
STATE_DIR="${NIGHTLY_DEPS_STATE:-$HOME/.local/share/compass/nightly-deps-agent}"
