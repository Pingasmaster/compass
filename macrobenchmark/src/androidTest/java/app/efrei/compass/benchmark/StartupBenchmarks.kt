 ...
 * require a managed device (Pixel 7a / API 37 / Google APIs / arm64-v8a).
 * They are intended for the optional `baseline-profile` GitHub Actions
 * workflow which has KVM access.
 */
package app.efrei.compass.benchmark
