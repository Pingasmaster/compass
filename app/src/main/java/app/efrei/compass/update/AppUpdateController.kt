package app.efrei.compass.update

import android.os.Build
import android.util.Log
import app.efrei.compass.BuildConfig
...
import app.efrei.compass.util.isAtLeastCinnamonBun
 ...
 *
 * Cold start: [app.efrei.compass.CompassApplication.onCreate] calls
...
class AppUpdateController(private val service: AppUpdateService, private val prefs: UserPreferences, ioDispatcher: CoroutineDispatcher) {
    ...
    /**
     * Idempotent per process. Fires once from [app.efrei.compass.CompassApplication.onCreate].
    ...
    /**
     * Called by [app.efrei.compass.CompassApplication.onTrimMemory] when the OS
